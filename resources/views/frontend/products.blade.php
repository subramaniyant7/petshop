                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img style="height:400px;width:100%"
                                                    src="{{ URL::asset(FRONTEND . '/img/Proteins.png') }}" alt=""
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img style="height:400px;width:100%"
                                                    src="{{ URL::asset(FRONTEND . '/img/organs.png') }}" alt=""
                                                    class="rounded img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img style="height:400px;width:100%"
                                                    src="{{ URL::asset(FRONTEND . '/img/Grains.png') }}" alt=""
                                                    class="rounded img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img style="height:400px;width:100%"
                                                    src="{{ URL::asset(FRONTEND . '/img/Coconut-oil.png') }}"
                                                    alt="" class="rounded img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <img style="height:400px;width:100%"
                                                    src="{{ URL::asset(FRONTEND . '/img/Chia-Flax.png') }}"
                                                    alt="" class="rounded img-fluid">
                                            </div>
                                        </div>
                                    </div>
