            ...
            <div class="col-lg-12 page-with-sidebar">
                ...
                <div id="gallery-isotope" class="row row-eq-height mt-lg-5">
                    ...
                    @if (count($activeProducts))
                        @foreach ($activeProducts as $product)
                            ...
                            <div class="{{$product->product_for == 1 ? 'dogs' : 'cats'}} col-lg-6">
                                    ...
                                    <div class="adopt-card res-margin row bg-light pattern2">
                                        <div class="col-md-5">
                                            ...
                                            <div class="adopt-image d-flex flex-wrap align-items-center ">
                                                <a href="adoption-single.html">
                                                    <img src="{{ URL::asset('uploads/products/' . $product->product_image) }}" class="img-fluid" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-7 res-margin">
                                            ...
                                            <div class="caption-adoption">
                                                <h5 class="adoption-header"><a href="javascript:void(0)">{{ $product->product_name}}</a>
                                                </h5>
                                                <!-- List -->
                                                <ul class="list-unstyled">
                                                    <li><strong>Price:</strong> Rs.{{ $product->product_price}} / Gram</li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <p class="mt-4">
                        ...
                        nutrients.
                        <br />
                        <strong>Note:</strong> Legumes are not considered safe for cats and will not be a part of your
                        kitty’s meals.
