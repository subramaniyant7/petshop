                                                                    ...
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <a href="{{ url(FRONTENDURL) }}"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="{{ URL::asset(FRONTEND . '/img/Final_Logo_UntamePets_01.webp') }}"
                                                                                alt="U N T A M E Pets"
                                                                                title="U N T A M E Pets"
                                        ...
                                        <div
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ URL::asset(FRONTEND . '/img/image-4.png') }}"
                                                                            alt="Hero Image" title="Hero Image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 54%;max-width: 286.2px;"
                                                                            width="286.2"
                                                                            class="v-src-width v-src-max-width" />
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 22px; line-height: 30.8px;"><strong><span
                                                                                style="line-height: 30.8px; font-size: 22px;"><span
                                                                                    style="font-family: Lato, sans-serif; line-height: 30.8px; font-size: 22px;">Hello
                                                                                    {{ $email }},</span></span></strong></span>
                                                                </p>
                                                            </div>
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 5px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <h2
                                                                style="margin: 0px; color: #141414; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 28px;">
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 12px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <h1
                                                                style="margin: 0px; color: #024c20; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 41px;">
                                                                <div><strong>
                                                                        @php
                                                                            $otp = str_split((string) $otp);
                                                                        @endphp
                                                                        @foreach ($otp as $otpnumber)
                                                                            <span
                                                                                style="text-decoration: underline;">{{ $otpnumber }}</span>
                                                                        @endforeach
                                                                    </strong>
                                                                </div>
                                                            </h1>
                                            ...
                                            <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 40px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #0081ff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="menu" style="text-align:center">
                                                                ...
                                                                <a href="{{ url(FRONTENDURL.'faq') }}" target="_blank"
                                                                    style="padding:5px 16px;display:inline-block;color:#a3b2c3;font-family:'Open Sans',sans-serif;font-size:15px;text-decoration:none"
                                                                ...
                                                                <!--[if (mso)|(IE)]><td style="padding:5px 16px"><![endif]-->
                                                                <span
                                                                    style="padding:5px 16px;display:inline-block;color:#5f6d7e;font-family:'Open Sans',sans-serif;font-size:15px"
                                                                ...
                                                                <a href="{{ url(FRONTENDURL.'terms_conditions') }}"
                                                                    target="_blank"
                                                                    style="padding:5px 16px;display:inline-block;color:#a3b2c3;font-family:'Open Sans',sans-serif;font-size:15px;text-decoration:none"
                                                                    class="v-padding v-layout-display">
                                                                    Terms & Condition
                                                                ...
                                                                <a href="{{ url(FRONTENDURL.'about_us') }}"
                                                                    target="_blank"
                                                                    style="padding:5px 16px;display:inline-block;color:#a3b2c3;font-family:'Open Sans',sans-serif;font-size:15px;text-decoration:none"
                                                                    class="v-padding v-layout-display">
                                                                    About Us
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <table height="0px" align="center" border="0"
                                                                cellpadding="0" cellspacing="0" width="83%"
                                                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #443e3e;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                <tbody>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/untamepets"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ URL::asset(FRONTEND . '/img/image-3.png') }}"
                                                                                            alt="Facebook"
                                                                                            title="Facebook"
                                                                                            width="32"
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://instagram.com/untamepets"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{ URL::asset(FRONTEND . '/img/image-2.png') }}"
                                                                                            alt="Instagram"
                                                                                            title="Instagram"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://twitter.com/untamepets"
                                                                                        title="Twitter"
                                                                                        target="_blank">
                                                                                        <img src="{{ URL::asset(FRONTEND . '/img/image-1.png') }}"
                                                                                            alt="Twitter"
                                                                                            title="Twitter"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
