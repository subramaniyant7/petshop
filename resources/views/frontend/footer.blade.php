    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 text-center ">
                <img src="{{ URL::asset(FRONTEND . '/img/Final_Logo_UntamePets_01.webp') }}" class="logo-footer img-fluid"
                    alt="" />
                <!-- Start Social Links -->
            ...
            <div class="col-lg-3">
                ...
                <p class="mt-3">Elit aenean, amet eros curabitur. Wisi ad eget ipsum metus sociis Cras enim wisi
                    elit aenean.</p>
            </div>
            <!--/ col-lg -->
            <div class="col-lg-3">
        ...
        <div class="row">
            <div class="credits col-sm-12">
                <p>Copyright {{date('Y')}} / Developed by <a href="https://www.niftysoft.com/" target="_blank">NiftySoft Solution Pvt Ltd</a></p>
            </div>
        </div>
        <!--/col-lg-12-->
    </div>
