...
<head>
		...
		<title>Untame Pets Cpanel</title>
		<meta name="description" content="Classified admin" />
		<meta name="keywords" content="admin" />
		<meta name="author" content="Untame Pets"/>
		...
		<!-- vector map CSS -->
        <link href="{{ URL::asset(ADMIN.'/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
	...
	<body>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									...
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to Control Panel</h3>
										...
										<div class="form-wrap">
											<form action="{{ url(ADMINURL.'/login') }}" method="post">
												...
												<div class="form-group">
													...
													<input type="email" class="form-control" name="admin_name"  value="{{ old('admin_name')}}" required>
												</div>
												<div class="form-group">
		...
		<script src="{{ URL::asset(ADMIN.'/vendors/bower_components/jasny-bootstrap/dist/js/jasny-bootstrap.min.js') }}"></script>
